...
//   fileUrl:string='';
//   constructor(private main:MainpageService,private router:Router,private cdr:ChangeDetectorRef,private toastr:ToastrService,private aws:AwsService) { }
...
//     this.main.getPresignedUrl(fileName, fileType, this.user.user_id).subscribe({
//       next:(response) => {
...
//         next:() => {
//         this.aws.updateProfilePic(this.user.user_id, fileName,presignedUrl).subscribe({
//           next:(response) => {
